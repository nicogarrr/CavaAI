...
export function ChartLoadingSkeleton() {
    return (
        <div className="w-full min-w-0 bg-surface-1 rounded-lg border border-gray-700 p-4 sm:p-6">
            <span className="sr-only" role="status">Cargando…</span>
            <div aria-hidden>
...
export function TableLoadingSkeleton({ rows = 5 }: { rows?: number }) {
    return (
        <div className="w-full min-w-0 bg-surface-1 rounded-lg border border-gray-700 p-4">
            <span className="sr-only" role="status">Cargando…</span>
            <div aria-hidden>
...
export function GenericLoadingSkeleton({
    ...
    return (
        <div className={`${GENERIC_WIDTH_CLASSES[width]} bg-surface-1 rounded-lg border border-gray-700 p-6`}>
            <span className="sr-only" role="status">Cargando…</span>
            <div aria-hidden>
