...
def montecarlo(
    ...
    seed: int | None = None,
    title: str = "Montecarlo Simulation",
    figsize: tuple[float, float] = (10, 6),
    grayscale: bool = False,
    fontname: str = "Arial",
    ylabel: bool = True,
    ...
    """
    Plot Montecarlo simulation results.
    ...
    title : str, optional
        Chart title (default: "Montecarlo Simulation").
    figsize : tuple, optional
