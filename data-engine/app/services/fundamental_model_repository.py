...
class FundamentalModelRepository:
    ...
    def fingerprints(self, payload: dict[str, Any]) -> dict[str, str]:
        ...
        inputs = {
            ...
            "driver_assumptions": payload.get("driver_assumptions"),
        ...
        for driver in payload.get("driver_model") or []:
            db.add(
                FundamentalDriver(
                    ...
                    currency=driver.get("currency") or "N/A",
                    time_basis=driver.get("time_basis") or "point_in_time",
                    geography=driver.get("geography") or "global",
                    segment=driver.get("segment") or "consolidated",
                    period=driver.get("period") or "unknown",
                    source=driver.get("source") or "financial_fact",
